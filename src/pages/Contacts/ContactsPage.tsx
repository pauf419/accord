...
import m from "./ContactsPage.module.sass"
...
function ContactsPage() {
    return (
        <div className={m.ContactsPageWrapper}>
            <PageNavigator
                title="Контакты"
                paths={[{
                    value: "Главная",
            ...
            <div className={m.ContactsContent}>
                <div className={m.ContactsTitle}>
                    <h1>Напишите нам</h1>
                </div>
                <h1 className="logo" style={{color: "#000"}}>ACCORD<span className="primary">™</span></h1>
